            ...
            <form onSubmit={handleCreateNote} className="bg-white dark:bg-zinc-900 rounded-3xl p-8 shadow-xl border border-indigo-100 dark:border-zinc-800">
              ...
              <div className="mt-6 flex justify-end gap-3">
                <button
                  type="button"
                  onClick={() => setIsCreating(false)}
                  className="px-6 py-2 text-sm font-semibold text-zinc-500 hover:text-zinc-700"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="rounded-xl bg-indigo-600 px-8 py-2 text-sm font-semibold text-white shadow-lg shadow-indigo-500/20 hover:bg-indigo-500"
                >
                  Save Note
                </button>
              </div>
